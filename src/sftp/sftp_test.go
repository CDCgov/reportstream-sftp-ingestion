...
func Test_getSshClientHostKeyCallback_returnErrorWhenUnableToParsePublicKey(t *testing.T) {
	serverKey := "ssh-rsa  sschuresko@flexion-mac-J40DPF4YQR"
	actualParsedKeyCallback, err := getSshClientHostKeyCallback(serverKey)
...
func Test_getPublicKeysForSshClient_returnErrorWhenUnableToRetrieveSFTPKey(t *testing.T) {
	...
	mockCredentialGetter := new(MockCredentialGetter)
	mockCredentialGetter.On("GetSecret", mock.Anything).Return("Unable to retrieve SFTP key", nil)
